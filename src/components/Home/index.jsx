  ...
  return (
    <>
      ...
      <div className="banner-img">
        <div className="title">
          <h3>
            Discover Your <span>Passion </span> Shape
            <br />
            <span>Your Career</span>
          </h3>
          <div className="small-tagline">
            <p>At Vocation Training, we focus on delivering industry-relevant education that combines theory and practice. Explore our
              courses and take the first step towards your future today!</p>
          </div>
        </div>
